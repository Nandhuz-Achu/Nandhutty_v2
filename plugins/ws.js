...
// EXPORTING
        ...
        await message.client.sendMessage(message.jid, Buffer(respovideo.data), MessageType.video, {mimetype: Mimetype.mp4, quoted: message.data, caption: '◄━━━━━━━⦁⦁ *ᴍᴀᴅᴇ ʙʏ ɴᴀɴᴅʜᴜᴛᴛʏ* ⦁⦁━━━━━━━━►'})
